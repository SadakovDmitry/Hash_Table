# Оптимизация хеш таблиц при помощи низкоуровневых языков программирования.
## Задача
...
Рассмотрим все способы хеширования и построим для каждого график на котором показано распределение элементов по хеш-таблице.
...
* ### strlen -> my_strlen
    Переписав функцию с используя прямую ассемблерную вставку, заметим ,что она даже медленнее стандартной strlen, так как стандартная функция strlen написана через SIMD инструкции. Попробуем обогнать!!!
    <details>
    <summary>my_strcmp</summary>
